...
:--|:--|:--|
1.Identified the required apparatus, glassware’s and understand the connection of apparatus use in kjaldahl distillation. | Simulation show  all the require apparatus, glass, water and its connections with the help of mouse pointer. | Understanding the setup and handling the apparatus and glassware carefully.
2.Take 50ml of sample, Demineralised water and standard solution in measuring cylinder in 3 different distillation flask . Add demineralised water 200ml in all 3 distillation flask | Simulation display flask , measuring cylinder, Demineralised water standard solution and sample add in 3 distillation flask.Simulation display Demineralised in beaker and adding demineralised water by measuring 200ml in all distillation flasks with the help of mouse pointer. | Selection of sample quantity and standard solution. Adding of sample  and demineralised for test.
3.Add 25ml borate buffer then add 6N NaOH to make pH <9.5 using pH meter. | Simulation display flask and 25ml measuring cylinder and add 25ml borate buffer in all distillation flask. | Adding of borate buffer and checking of pH.
4.Add glass beads in all distillation flask. | Simulation display Glass beads and added in all distillation flask with the help of mouse pointer. | For adding the glass beads.
5.Take 3 number 500ml conical flask and add 50ml boric acid+ mixed indicator in all conical flask. Then Connect the distillation flask and check for any leakage and start boiling up to boric acid become 200ml. | Simulation display 3 number 500ml conical flask and adding 50ml boric acid and mixed indicator in all conical flask and start boiling with the help of mouse pointer. | Taking the conical flask and adding the reagents in the samples.
6.Cool and Titrate collected distillate with 0.02N sulphuric acid until solution turn lavender colour. | Simulation display the glassware and show the titration with the help of mouse pointer. | For titration of the distillate solutions.
7.Using formula calculate the concentration of Ammonia-Nitrogen | And calculate using formula with the help of mouse pointer. | For calculation of concentration of Ammonia- Nitrogen
8.Compare and conclude the standard concentration to experimental concentration of standard solution.If error is <5% accept otherwise repeat test. | Simulation display standard concentration to experimental concentration of standard solution and compare is it  <5%. | To understand the comparison between standard concentration and experimental concentration.
